          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  CustomText(title: "price".tr, fontWeight: FontWeight.normal),
                  SizedBox(height: 5),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                CustomText(title: "size".tr, fontWeight: .w500),
                          ...
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                CustomText(title: "color".tr, fontWeight: .w500),
                                CircleAvatar(
                      ...
                      SizedBox(height: 20),
                      CustomText(title: "details".tr, fontSize: 26),
                      SizedBox(height: 10),
                      CustomText(
